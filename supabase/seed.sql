...
--   charts  Куплено, Расходы сентября, Тренировки, Дневник головных болей, Давление
...
(
  'b11e0000-0000-4000-8000-000000000071',
  'a11e0000-0000-4000-8000-000000000003',
  'Дневник головных болей',
  'Приступы со шкалой боли во времени: пик в свёрнутой ячейке, симптомы, лекарства и связь с давлением.',
  '🤕',
  'headache_diary',
  '{"fields":[{"id":"title","key":"title","name":"Эпизод","type":"text","required":true,"config":{"maxLength":160}},{"id":"kind","key":"kind","name":"Тип","type":"select","config":{"options":[{"value":"migraine","label":"Мигрень","color":"#be123c"},{"value":"tension","label":"Напряжения","color":"#b45309"},{"value":"cluster","label":"Кластерная","color":"#7c3aed"},{"value":"mixed","label":"Смешанная","color":"#2563eb"},{"value":"unknown","label":"Неясно","color":"#6e6578"},{"value":"other","label":"Другое"}]}},{"id":"started_at","key":"started_at","name":"Начало","type":"datetime","required":true},{"id":"ended_at","key":"ended_at","name":"Конец","type":"datetime"},{"id":"ongoing","key":"ongoing","name":"Ещё идёт","type":"boolean"},{"id":"intensity","key":"intensity","name":"Интенсивность","type":"sublist","description":"Каждая строка — момент или промежуток. В таблице список свёрнут до пика и границ приступа.","config":{"sublistSummary":{"mode":"peak_span","valueFieldId":"level","startFieldId":"at","endFieldId":"until"},"subfields":[{"id":"at","key":"at","name":"С","type":"datetime","required":true},{"id":"until","key":"until","name":"До","type":"datetime"},{"id":"level","key":"level","name":"Уровень","type":"select","required":true,"config":{"options":[{"value":"0","label":"0 — не болит","description":"Боли нет.","color":"#6e6578"},{"value":"1","label":"1 — едва заметно","description":"Ощущается, только если специально прислушаться.","color":"#0f766e"},{"value":"2","label":"2 — слабая","description":"Лёгкая боль, на неё можно не обращать внимания.","color":"#0f766e"},{"value":"3","label":"3 — заметная","description":"Боль есть, но почти не мешает делам.","color":"#0f766e"},{"value":"4","label":"4 — умеренная","description":"Отвлекает, но работу ещё можно продолжать.","color":"#b45309"},{"value":"5","label":"5 — мешает","description":"Трудно игнорировать, концентрация падает.","color":"#b45309"},{"value":"6","label":"6 — сильная","description":"Мешает думать и работать, хочется остановиться.","color":"#b45309"},{"value":"7","label":"7 — очень сильная","description":"Сложно выполнять обычные действия.","color":"#c2410c"},{"value":"8","label":"8 — тяжёлая","description":"Почти ни о чём другом не получается думать.","color":"#c2410c"},{"value":"9","label":"9 — невыносимая","description":"Почти невозможно что-либо делать.","color":"#be123c"},{"value":"10","label":"10 — максимум","description":"Худшая боль, какую можно представить.","color":"#9f1239"}]}},{"id":"note","key":"note","name":"Комментарий","type":"text","config":{"maxLength":200}}]}},{"id":"laterality","key":"laterality","name":"Сторона","type":"select","config":{"options":[{"value":"left","label":"Слева"},{"value":"right","label":"Справа"},{"value":"both","label":"С обеих сторон"},{"value":"shifting","label":"Переходит"}]}},{"id":"location","key":"location","name":"Место","type":"multiselect","config":{"options":[{"value":"forehead","label":"Лоб"},{"value":"left_temple","label":"Левый висок"},{"value":"right_temple","label":"Правый висок"},{"value":"crown","label":"Макушка"},{"value":"occiput","label":"Затылок"},{"value":"neck","label":"Шея"},{"value":"left_eye","label":"Левый глаз"},{"value":"right_eye","label":"Правый глаз"},{"value":"face","label":"Лицо"},{"value":"whole","label":"Вся голова"}]}},{"id":"character","key":"character","name":"Характер","type":"multiselect","config":{"options":[{"value":"throbbing","label":"Пульсирующая"},{"value":"pressing","label":"Давящая"},{"value":"tight","label":"Сжимающая"},{"value":"stabbing","label":"Колющая"},{"value":"burning","label":"Жгучая"},{"value":"dull","label":"Тупая"},{"value":"exploding","label":"Распирающая"}]}},{"id":"symptoms","key":"symptoms","name":"Симптомы","type":"multiselect","config":{"options":[{"value":"visual","label":"Нарушения зрения / аура"},{"value":"photophobia","label":"Свет режет"},{"value":"phonophobia","label":"Звук мешает"},{"value":"osmophobia","label":"Запахи раздражают"},{"value":"nausea","label":"Тошнота"},{"value":"vomiting","label":"Рвота"},{"value":"dizziness","label":"Головокружение"},{"value":"neck","label":"Скована шея"},{"value":"tearing","label":"Слезотечение"},{"value":"nasal","label":"Заложен нос"},{"value":"speech","label":"Трудно говорить"},{"value":"numbness","label":"Онемение"},{"value":"confusion","label":"Путаница"},{"value":"yawning","label":"Зевота"},{"value":"tinnitus","label":"Шум в ушах"},{"value":"other","label":"Другое"}]}},{"id":"started_asleep","key":"started_asleep","name":"Началась во сне","type":"boolean"},{"id":"ended_asleep","key":"ended_asleep","name":"Закончилась во сне","type":"boolean"},{"id":"impact","key":"impact","name":"Влияние на дела","type":"select","config":{"options":[{"value":"none","label":"Не мешала","color":"#0f766e"},{"value":"slowed","label":"Замедлила","color":"#b45309"},{"value":"stopped","label":"Пришлось лечь","color":"#be123c"}]}},{"id":"meds","key":"meds","name":"Лекарства","type":"sublist","config":{"subfields":[{"id":"taken_at","key":"taken_at","name":"Принял","type":"datetime","required":true},{"id":"name","key":"name","name":"Препарат","type":"text","required":true,"config":{"maxLength":80}},{"id":"dose","key":"dose","name":"Доза","type":"text","config":{"maxLength":40}},{"id":"felt_at","key":"felt_at","name":"Эффект ощутил","type":"datetime"},{"id":"effect","key":"effect","name":"Эффект","type":"select","config":{"options":[{"value":"none","label":"Не помогло","color":"#6e6578"},{"value":"partial","label":"Чуть легче","color":"#b45309"},{"value":"good","label":"Заметно лучше","color":"#0f766e"},{"value":"gone","label":"Боль ушла","color":"#0f766e"},{"value":"worse","label":"Стало хуже","color":"#be123c"}]}},{"id":"note","key":"note","name":"Заметка","type":"text","config":{"maxLength":160}}]}},{"id":"activity","key":"activity","name":"Нагрузка","type":"sublist","config":{"subfields":[{"id":"at","key":"at","name":"Когда","type":"datetime"},{"id":"kind","key":"kind","name":"Тип","type":"select","config":{"options":[{"value":"walk","label":"Ходьба"},{"value":"run","label":"Бег"},{"value":"gym","label":"Силовая"},{"value":"yoga","label":"Йога / растяжка"},{"value":"cycle","label":"Велосипед"},{"value":"chores","label":"Домашние дела"},{"value":"other","label":"Другое"}]}},{"id":"intensity","key":"intensity","name":"Интенсивность","type":"select","config":{"options":[{"value":"light","label":"Лёгкая","color":"#0f766e"},{"value":"moderate","label":"Средняя","color":"#b45309"},{"value":"vigorous","label":"Тяжёлая","color":"#be123c"}]}},{"id":"effect","key":"effect","name":"Эффект на боль","type":"select","config":{"options":[{"value":"better_during","label":"Во время легче"},{"value":"worse_during","label":"Во время хуже"},{"value":"better_after","label":"После легче"},{"value":"worse_after","label":"После хуже"},{"value":"none","label":"Без эффекта"},{"value":"mixed","label":"Смешанно"}]}},{"id":"note","key":"note","name":"Комментарий","type":"text","config":{"maxLength":200}}]}},{"id":"triggers","key":"triggers","name":"Возможные причины","type":"multiselect","config":{"options":[{"value":"sleep_loss","label":"Недосып"},{"value":"oversleep","label":"Переспал"},{"value":"stress","label":"Стресс"},{"value":"weather","label":"Погода / давление"},{"value":"screens","label":"Экраны"},{"value":"skipped_meal","label":"Пропустил еду"},{"value":"alcohol","label":"Алкоголь"},{"value":"caffeine","label":"Кофеин / отмена"},{"value":"hormones","label":"Гормоны / цикл"},{"value":"neck","label":"Шея / осанка"},{"value":"smell","label":"Запах"},{"value":"light","label":"Яркий свет"},{"value":"dehydration","label":"Мало воды"},{"value":"heat","label":"Жара"},{"value":"travel","label":"Дорога"},{"value":"food","label":"Еда"},{"value":"exercise","label":"Нагрузка"}]}},{"id":"helped","key":"helped","name":"Что помогло","type":"multiselect","config":{"options":[{"value":"dark","label":"Темнота"},{"value":"sleep","label":"Сон"},{"value":"water","label":"Вода"},{"value":"caffeine","label":"Кофеин"},{"value":"painkiller","label":"Обезболивающее"},{"value":"cold","label":"Холод"},{"value":"walk","label":"Прогулка"},{"value":"air","label":"Свежий воздух"},{"value":"massage","label":"Массаж / шея"},{"value":"rest","label":"Покой"},{"value":"time","label":"Само прошло"}]}},{"id":"bp_readings","key":"bp_readings","name":"Давление","type":"relation","config":{"relatedListId":"b11e0000-0000-4000-8000-000000000072","allowMultiple":true,"relationDisplay":"title"}},{"id":"notes","key":"notes","name":"Комментарий","type":"textarea","config":{"maxLength":2000}}],"titleFieldId":"title","dateFieldId":"started_at","groupFieldId":"kind"}'::jsonb,
  '{"mode":"table","allowedKinds":["table","timeline","calendar","board"],"activeViewId":"v-table","groupFieldId":"kind","dateFieldId":"started_at","views":[{"id":"v-table","name":"Таблица","kind":"table","density":"comfortable","dateFieldId":"started_at","titleFieldId":"title"},{"id":"v-time","name":"Лента","kind":"timeline","dateFieldId":"started_at","titleFieldId":"title"},{"id":"v-cal","name":"Календарь","kind":"calendar","dateFieldId":"started_at","titleFieldId":"title"},{"id":"v-board","name":"По типу","kind":"board","groupFieldId":"kind","titleFieldId":"title"}]}'::jsonb,
  '{"showcase":{"featured":true,"topic":"charts"}}'::jsonb,
  'public',
  'owner'
),
(
  'b11e0000-0000-4000-8000-000000000072',
  'a11e0000-0000-4000-8000-000000000003',
  'Давление',
  'Измерения с пульсом, фото, кофеином, сном и привязкой к приступу боли — графики систолы и пульса.',
  '❤️',
  'blood_pressure',
  '{"fields":[{"id":"title","key":"title","name":"Запись","type":"text","required":true,"config":{"maxLength":160}},{"id":"measured_at","key":"measured_at","name":"Дата и время","type":"datetime","required":true},{"id":"systolic","key":"systolic","name":"Систолическое","type":"integer","required":true,"config":{"min":70,"max":260}},{"id":"diastolic","key":"diastolic","name":"Диастолическое","type":"integer","required":true,"config":{"min":40,"max":160}},{"id":"pulse","key":"pulse","name":"Пульс","type":"integer","config":{"min":30,"max":220}},{"id":"irregular","key":"irregular","name":"Неровный пульс","type":"boolean"},{"id":"photo","key":"photo","name":"Фото измерения","type":"image","config":{"maxSizeMb":2}},{"id":"comment","key":"comment","name":"Комментарий","type":"text","config":{"maxLength":200}},{"id":"position","key":"position","name":"Положение","type":"select","config":{"defaultValue":"sitting","options":[{"value":"sitting","label":"Сидя"},{"value":"lying","label":"Лёжа"},{"value":"standing","label":"Стоя"}]}},{"id":"arm","key":"arm","name":"Рука","type":"select","config":{"options":[{"value":"left","label":"Левая"},{"value":"right","label":"Правая"}]}},{"id":"mins_exercise","key":"mins_exercise","name":"Минут после нагрузки","type":"integer","config":{"min":0,"max":300}},{"id":"mins_meal","key":"mins_meal","name":"Минут после еды","type":"integer","config":{"min":0,"max":300}},{"id":"caffeine","key":"caffeine","name":"Кофеин","type":"select","config":{"defaultValue":"none","options":[{"value":"none","label":"Нет","color":"#0f766e"},{"value":"little","label":"Немного","color":"#6e6578"},{"value":"moderate","label":"Умеренно","color":"#b45309"},{"value":"a_lot","label":"Много","color":"#be123c"}]}},{"id":"nicotine","key":"nicotine","name":"Никотин","type":"select","config":{"defaultValue":"none","options":[{"value":"none","label":"Нет","color":"#0f766e"},{"value":"little","label":"Немного","color":"#6e6578"},{"value":"moderate","label":"Умеренно","color":"#b45309"},{"value":"a_lot","label":"Много","color":"#be123c"}]}},{"id":"sleep_hours","key":"sleep_hours","name":"Сон, часы","type":"number","config":{"min":0,"max":16}},{"id":"sleep_quality","key":"sleep_quality","name":"Сон","type":"select","config":{"options":[{"value":"poor","label":"Плохой","color":"#be123c"},{"value":"fair","label":"Так себе","color":"#b45309"},{"value":"good","label":"Хороший","color":"#0f766e"},{"value":"excellent","label":"Отличный","color":"#0f766e"}]}},{"id":"stress","key":"stress","name":"Стресс","type":"select","config":{"options":[{"value":"none","label":"Нет","color":"#0f766e"},{"value":"mild","label":"Слабый","color":"#6e6578"},{"value":"moderate","label":"Умеренный","color":"#b45309"},{"value":"high","label":"Сильный","color":"#be123c"}]}},{"id":"wellbeing","key":"wellbeing","name":"Самочувствие","type":"rating","config":{"ratingMax":10,"min":1,"max":10}},{"id":"headache_now","key":"headache_now","name":"Головная боль сейчас","type":"select","config":{"options":[{"value":"none","label":"Нет","color":"#0f766e"},{"value":"mild","label":"Слабая","color":"#b45309"},{"value":"moderate","label":"Средняя","color":"#c2410c"},{"value":"severe","label":"Сильная","color":"#be123c"}]}},{"id":"headache","key":"headache","name":"Приступ","type":"relation","config":{"relatedListId":"b11e0000-0000-4000-8000-000000000071","allowMultiple":true,"relationDisplay":"title"}},{"id":"category","key":"category","name":"Оценка","type":"select","config":{"options":[{"value":"low","label":"Пониженное","color":"#2563eb"},{"value":"normal","label":"Норма","color":"#0f766e"},{"value":"elevated","label":"Повышенное","color":"#b45309"},{"value":"high","label":"Высокое","color":"#be123c"},{"value":"crisis","label":"Кризис","color":"#9f1239"}]}},{"id":"notes","key":"notes","name":"Примечания","type":"textarea","config":{"maxLength":1500}}],"titleFieldId":"title","dateFieldId":"measured_at","imageFieldId":"photo","groupFieldId":"category"}'::jsonb,
  '{"mode":"table","allowedKinds":["table","timeline","calendar","board"],"activeViewId":"v-table","groupFieldId":"category","dateFieldId":"measured_at","views":[{"id":"v-table","name":"Таблица","kind":"table","density":"comfortable","dateFieldId":"measured_at","titleFieldId":"title"},{"id":"v-time","name":"Лента","kind":"timeline","dateFieldId":"measured_at","titleFieldId":"title"},{"id":"v-cal","name":"Календарь","kind":"calendar","dateFieldId":"measured_at","titleFieldId":"title"},{"id":"v-board","name":"Оценка","kind":"board","groupFieldId":"category","titleFieldId":"title"}]}'::jsonb,
  '{"showcase":{"featured":true,"topic":"charts"}}'::jsonb,
  'public',
  'owner'
)
...
('c11e0000-0000-4000-8000-000000000801', 'b11e0000-0000-4000-8000-000000000071', '{"title":"Утренняя мигрень","kind":"migraine","started_at":"2026-09-08T06:40","ended_at":"2026-09-08T14:50","ongoing":false,"intensity":[{"at":"2026-09-08T06:40","until":"2026-09-08T08:20","level":"5","note":"проснулась с болью"},{"at":"2026-09-08T08:20","until":"2026-09-08T10:00","level":"8","note":"накрыло после кофе"},{"at":"2026-09-08T10:00","until":"2026-09-08T14:50","level":"4","note":"после таблетки отпустило"}],"laterality":"left","location":["left_temple","left_eye","forehead"],"character":["throbbing","exploding"],"symptoms":["visual","photophobia","phonophobia","nausea"],"started_asleep":true,"ended_asleep":false,"impact":"stopped","meds":[{"taken_at":"2026-09-08T08:40","name":"Ибупрофен","dose":"400 мг","felt_at":"2026-09-08T09:15","effect":"partial","note":"тошнота чуть слабее"},{"taken_at":"2026-09-08T10:05","name":"Суматриптан","dose":"50 мг","felt_at":"2026-09-08T10:40","effect":"good"}],"activity":[{"at":"2026-09-08T07:10","kind":"walk","intensity":"light","effect":"worse_after","note":"до кухни — ок, потом хуже"}],"triggers":["sleep_loss","weather","caffeine"],"helped":["dark","painkiller","rest"],"bp_readings":[{"id":"c11e0000-0000-4000-8000-000000000821","title":"Утро, высокое"},{"id":"c11e0000-0000-4000-8000-000000000822","title":"После триптана"}],"notes":"Аура — зигзаги слева минут на 20. Давление утром было высоким."}'::jsonb, 1, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000802', 'b11e0000-0000-4000-8000-000000000071', '{"title":"После мониторов","kind":"tension","started_at":"2026-09-05T15:30","ended_at":"2026-09-05T19:10","ongoing":false,"intensity":[{"at":"2026-09-05T15:30","until":"2026-09-05T17:00","level":"3"},{"at":"2026-09-05T17:00","until":"2026-09-05T19:10","level":"4","note":"к вечеру давит обручем"}],"laterality":"both","location":["forehead","crown","neck"],"character":["pressing","tight"],"symptoms":["neck"],"started_asleep":false,"ended_asleep":false,"impact":"slowed","meds":[],"activity":[{"at":"2026-09-05T18:20","kind":"yoga","intensity":"light","effect":"better_after","note":"растяжка шеи"}],"triggers":["screens","neck"],"helped":["massage","walk","air"],"notes":"День за ноутбуком без перерывов."}'::jsonb, 2, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000803', 'b11e0000-0000-4000-8000-000000000071', '{"title":"Погода и давление","kind":"migraine","started_at":"2026-09-02T11:00","ended_at":"2026-09-02T18:30","ongoing":false,"intensity":[{"at":"2026-09-02T11:00","until":"2026-09-02T13:30","level":"6"},{"at":"2026-09-02T13:30","until":"2026-09-02T16:00","level":"7","note":"гром на улице"},{"at":"2026-09-02T16:00","until":"2026-09-02T18:30","level":"3"}],"laterality":"right","location":["right_temple","occiput"],"character":["throbbing","dull"],"symptoms":["phonophobia","nausea","dizziness"],"started_asleep":false,"ended_asleep":false,"impact":"slowed","meds":[{"taken_at":"2026-09-02T13:40","name":"Цитрамон","dose":"1 табл.","felt_at":"2026-09-02T14:20","effect":"partial"}],"activity":[],"triggers":["weather","stress"],"helped":["dark","water","painkiller"],"bp_readings":[{"id":"c11e0000-0000-4000-8000-000000000828","title":"Стрессовый день"}],"notes":"Перед грозой. Давление 154/98."}'::jsonb, 3, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000804', 'b11e0000-0000-4000-8000-000000000071', '{"title":"Короткая колющая","kind":"other","started_at":"2026-08-28T12:15","ended_at":"2026-08-28T12:40","ongoing":false,"intensity":[{"at":"2026-08-28T12:15","until":"2026-08-28T12:40","level":"3","note":"несколько вспышек"}],"laterality":"right","location":["right_temple"],"character":["stabbing"],"symptoms":[],"started_asleep":false,"ended_asleep":false,"impact":"none","meds":[],"activity":[],"triggers":[],"helped":["time"],"notes":"Прошло само, лекарств не брала."}'::jsonb, 4, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000805', 'b11e0000-0000-4000-8000-000000000071', '{"title":"Цикл, тяжёлая ночь","kind":"migraine","started_at":"2026-08-24T23:50","ended_at":"2026-08-25T11:20","ongoing":false,"intensity":[{"at":"2026-08-24T23:50","until":"2026-08-25T03:00","level":"7","note":"не могла уснуть"},{"at":"2026-08-25T03:00","until":"2026-08-25T07:00","level":"9"},{"at":"2026-08-25T07:00","until":"2026-08-25T11:20","level":"5"}],"laterality":"left","location":["left_temple","whole","neck"],"character":["throbbing","exploding","burning"],"symptoms":["visual","photophobia","phonophobia","nausea","vomiting","yawning"],"started_asleep":false,"ended_asleep":true,"impact":"stopped","meds":[{"taken_at":"2026-08-25T00:20","name":"Парацетамол","dose":"500 мг","felt_at":"2026-08-25T01:00","effect":"none"},{"taken_at":"2026-08-25T03:10","name":"Суматриптан","dose":"50 мг","felt_at":"2026-08-25T03:50","effect":"good"}],"activity":[],"triggers":["hormones","sleep_loss"],"helped":["painkiller","sleep","dark","cold"],"notes":"Заснула под утро, проснулась уже легче."}'::jsonb, 5, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000806', 'b11e0000-0000-4000-8000-000000000071', '{"title":"После зала","kind":"mixed","started_at":"2026-08-30T19:40","ended_at":"2026-08-30T22:15","ongoing":false,"intensity":[{"at":"2026-08-30T19:40","until":"2026-08-30T20:30","level":"4","note":"ещё в зале"},{"at":"2026-08-30T20:30","until":"2026-08-30T22:15","level":"6","note":"дома усилилась"}],"laterality":"both","location":["occiput","neck","crown"],"character":["pressing","dull"],"symptoms":["neck","dizziness"],"started_asleep":false,"ended_asleep":false,"impact":"slowed","meds":[{"taken_at":"2026-08-30T20:45","name":"Ибупрофен","dose":"400 мг","felt_at":"2026-08-30T21:20","effect":"partial"}],"activity":[{"at":"2026-08-30T18:30","kind":"gym","intensity":"vigorous","effect":"better_during","note":"во время сета легче, после — хуже"},{"at":"2026-08-30T21:00","kind":"walk","intensity":"light","effect":"none"}],"triggers":["exercise","dehydration"],"helped":["water","painkiller"],"bp_readings":[{"id":"c11e0000-0000-4000-8000-000000000823","title":"После пробежки"}],"notes":"Мало пила на тренировке."}'::jsonb, 6, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000807', 'b11e0000-0000-4000-8000-000000000071', '{"title":"Вокруг глаза","kind":"cluster","started_at":"2026-09-01T02:10","ended_at":"2026-09-01T03:05","ongoing":false,"intensity":[{"at":"2026-09-01T02:10","until":"2026-09-01T02:40","level":"8"},{"at":"2026-09-01T02:40","until":"2026-09-01T03:05","level":"5"}],"laterality":"right","location":["right_eye","right_temple"],"character":["stabbing","burning"],"symptoms":["tearing","nasal","photophobia"],"started_asleep":true,"ended_asleep":false,"impact":"stopped","meds":[],"activity":[],"triggers":[],"helped":["air","time"],"notes":"Короткий ночной приступ, слезился правый глаз."}'::jsonb, 7, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000808', 'b11e0000-0000-4000-8000-000000000071', '{"title":"Фон с утра","kind":"tension","started_at":"2026-09-08T09:00","ended_at":null,"ongoing":true,"intensity":[{"at":"2026-09-08T09:00","level":"2","note":"ещё держится"}],"laterality":"both","location":["forehead"],"character":["dull","pressing"],"symptoms":[],"started_asleep":false,"ended_asleep":false,"impact":"none","meds":[],"activity":[],"triggers":["screens"],"helped":[],"notes":"После утренней мигрени остался лёгкий фон. Конец ещё не ставила."}'::jsonb, 8, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000809', 'b11e0000-0000-4000-8000-000000000071', '{"title":"После вина","kind":"migraine","started_at":"2026-08-16T10:20","ended_at":"2026-08-16T16:00","ongoing":false,"intensity":[{"at":"2026-08-16T10:20","until":"2026-08-16T12:00","level":"6"},{"at":"2026-08-16T12:00","until":"2026-08-16T16:00","level":"4"}],"laterality":"shifting","location":["forehead","left_temple","right_temple"],"character":["throbbing","pressing"],"symptoms":["nausea","osmophobia","photophobia"],"started_asleep":false,"ended_asleep":false,"impact":"slowed","meds":[{"taken_at":"2026-08-16T10:40","name":"Аспирин","dose":"500 мг","felt_at":"2026-08-16T11:30","effect":"partial"}],"activity":[{"at":"2026-08-16T13:00","kind":"walk","intensity":"light","effect":"better_during","note":"на воздухе легче"}],"triggers":["alcohol","sleep_loss","dehydration"],"helped":["water","sleep","air","caffeine"],"notes":"Ужин с красным вином накануне."}'::jsonb, 9, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000810', 'b11e0000-0000-4000-8000-000000000071', '{"title":"Пропуск обеда","kind":"tension","started_at":"2026-09-04T14:00","ended_at":"2026-09-04T17:45","ongoing":false,"intensity":[{"at":"2026-09-04T14:00","until":"2026-09-04T15:30","level":"4"},{"at":"2026-09-04T15:30","until":"2026-09-04T17:45","level":"5","note":"после совещания"}],"laterality":"both","location":["forehead","neck","occiput"],"character":["tight","pressing"],"symptoms":["neck","tinnitus"],"started_asleep":false,"ended_asleep":false,"impact":"slowed","meds":[],"activity":[{"at":"2026-09-04T16:10","kind":"chores","intensity":"light","effect":"worse_during"}],"triggers":["skipped_meal","stress","neck"],"helped":["water","massage","rest"],"notes":"Поела только в 18:00 — после еды отпустило."}'::jsonb, 10, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000821', 'b11e0000-0000-4000-8000-000000000072', '{"title":"Утро, высокое","measured_at":"2026-09-08T08:15","systolic":148,"diastolic":92,"pulse":78,"irregular":false,"photo":"https://picsum.photos/seed/bp-morning/400/600","comment":"До таблетки, сидя на кухне","position":"sitting","arm":"left","mins_exercise":null,"mins_meal":40,"caffeine":"little","nicotine":"none","sleep_hours":5.5,"sleep_quality":"poor","stress":"high","wellbeing":4,"headache_now":"severe","headache":[{"id":"c11e0000-0000-4000-8000-000000000801","title":"Утренняя мигрень"}],"category":"high","notes":"Плохо спала, мигрень уже на пике."}'::jsonb, 1, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000822', 'b11e0000-0000-4000-8000-000000000072', '{"title":"После триптана","measured_at":"2026-09-08T11:00","systolic":128,"diastolic":82,"pulse":68,"irregular":false,"photo":"https://picsum.photos/seed/bp-afterpill/400/600","comment":"Боль спала до 4","position":"sitting","arm":"left","caffeine":"none","nicotine":"none","sleep_hours":5.5,"sleep_quality":"poor","stress":"moderate","wellbeing":6,"headache_now":"mild","headache":[{"id":"c11e0000-0000-4000-8000-000000000801","title":"Утренняя мигрень"}],"category":"elevated","notes":"Через час после суматриптана."}'::jsonb, 2, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000823', 'b11e0000-0000-4000-8000-000000000072', '{"title":"После пробежки","measured_at":"2026-08-30T19:10","systolic":138,"diastolic":84,"pulse":96,"irregular":false,"photo":"https://picsum.photos/seed/bp-run/400/600","comment":"Ещё не остыла","position":"sitting","arm":"right","mins_exercise":5,"caffeine":"none","nicotine":"none","sleep_hours":7,"sleep_quality":"good","stress":"none","wellbeing":7,"headache_now":"mild","headache":[{"id":"c11e0000-0000-4000-8000-000000000806","title":"После зала"}],"category":"elevated"}'::jsonb, 3, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000824', 'b11e0000-0000-4000-8000-000000000072', '{"title":"Лёжа вечером","measured_at":"2026-09-07T22:40","systolic":118,"diastolic":76,"pulse":58,"irregular":false,"position":"lying","arm":"left","caffeine":"none","nicotine":"none","sleep_hours":8,"sleep_quality":"good","stress":"none","wellbeing":8,"headache_now":"none","category":"normal","notes":"Спокойный вечер, без кофе после обеда."}'::jsonb, 4, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000825', 'b11e0000-0000-4000-8000-000000000072', '{"title":"Много кофе","measured_at":"2026-09-03T10:05","systolic":142,"diastolic":88,"pulse":82,"irregular":false,"photo":"https://picsum.photos/seed/bp-coffee/400/600","comment":"Третья чашка","position":"sitting","arm":"left","mins_meal":20,"caffeine":"a_lot","nicotine":"none","sleep_hours":6,"sleep_quality":"fair","stress":"mild","wellbeing":6,"headache_now":"none","category":"high"}'::jsonb, 5, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000826', 'b11e0000-0000-4000-8000-000000000072', '{"title":"Стоя в поликлинике","measured_at":"2026-09-06T09:30","systolic":132,"diastolic":90,"pulse":88,"irregular":false,"comment":"Очередь, волновалась","position":"standing","arm":"right","caffeine":"little","nicotine":"none","sleep_hours":7,"sleep_quality":"fair","stress":"moderate","wellbeing":5,"headache_now":"none","category":"elevated","notes":"На приёме перемерили сидя — было 124/80."}'::jsonb, 6, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000827', 'b11e0000-0000-4000-8000-000000000072', '{"title":"После обеда","measured_at":"2026-09-04T15:10","systolic":126,"diastolic":82,"pulse":72,"irregular":false,"position":"sitting","arm":"left","mins_meal":25,"caffeine":"little","nicotine":"none","sleep_hours":6.5,"sleep_quality":"fair","stress":"moderate","wellbeing":6,"headache_now":"moderate","headache":[{"id":"c11e0000-0000-4000-8000-000000000810","title":"Пропуск обеда"}],"category":"elevated","notes":"Обед был поздний, голова уже ныла."}'::jsonb, 7, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000828', 'b11e0000-0000-4000-8000-000000000072', '{"title":"Стрессовый день","measured_at":"2026-09-02T13:20","systolic":154,"diastolic":98,"pulse":90,"irregular":true,"photo":"https://picsum.photos/seed/bp-stress/400/600","comment":"Перед созвоном","position":"sitting","arm":"left","caffeine":"moderate","nicotine":"little","sleep_hours":5,"sleep_quality":"poor","stress":"high","wellbeing":3,"headache_now":"moderate","headache":[{"id":"c11e0000-0000-4000-8000-000000000803","title":"Погода и давление"}],"category":"high","notes":"Редкий случай — сигарета с коллегой. Пульс неровный."}'::jsonb, 8, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000829', 'b11e0000-0000-4000-8000-000000000072', '{"title":"Ночное","measured_at":"2026-09-01T02:35","systolic":122,"diastolic":78,"pulse":64,"irregular":false,"position":"sitting","arm":"left","caffeine":"none","nicotine":"none","sleep_hours":3,"sleep_quality":"poor","stress":"mild","wellbeing":4,"headache_now":"severe","headache":[{"id":"c11e0000-0000-4000-8000-000000000807","title":"Вокруг глаза"}],"category":"normal","notes":"Разбудила боль вокруг глаза, давление при этом обычное."}'::jsonb, 9, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000830', 'b11e0000-0000-4000-8000-000000000072', '{"title":"Выходные","measured_at":"2026-08-23T11:00","systolic":116,"diastolic":74,"pulse":62,"irregular":false,"photo":"https://picsum.photos/seed/bp-weekend/400/600","position":"sitting","arm":"left","mins_exercise":90,"caffeine":"little","nicotine":"none","sleep_hours":8.5,"sleep_quality":"excellent","stress":"none","wellbeing":9,"headache_now":"none","category":"normal","notes":"Прогулка утром, потом измерение."}'::jsonb, 10, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000831', 'b11e0000-0000-4000-8000-000000000072', '{"title":"Гипотония после жары","measured_at":"2026-08-19T16:45","systolic":98,"diastolic":62,"pulse":54,"irregular":false,"comment":"Головокружение в метро","position":"sitting","arm":"left","caffeine":"none","nicotine":"none","sleep_hours":7,"sleep_quality":"good","stress":"none","wellbeing":5,"headache_now":"mild","category":"low","notes":"Жара, мало воды. Голова скорее тяжёлая, не мигрень."}'::jsonb, 11, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003'),
('c11e0000-0000-4000-8000-000000000832', 'b11e0000-0000-4000-8000-000000000072', '{"title":"Контроль у врача","measured_at":"2026-08-12T09:00","systolic":124,"diastolic":80,"pulse":70,"irregular":false,"photo":"https://picsum.photos/seed/bp-clinic/400/600","comment":"Кабинет терапевта, манжета клиники","position":"sitting","arm":"right","mins_meal":60,"caffeine":"none","nicotine":"none","sleep_hours":7.5,"sleep_quality":"good","stress":"mild","wellbeing":7,"headache_now":"none","category":"normal"}'::jsonb, 12, false, null, 'a11e0000-0000-4000-8000-000000000003', 'a11e0000-0000-4000-8000-000000000003')
on conflict (id) do update set
  values = excluded.values,
  position = excluded.position,
  is_checked = excluded.is_checked,
...
('e11e0000-0000-4000-8000-000000000017', 'c11e0000-0000-4000-8000-000000000801', 'a11e0000-0000-4000-8000-000000000001', 'Похоже на мои утренние — держи дневник рядом с тонометром.', 'rose', true, true),
('e11e0000-0000-4000-8000-000000000018', 'c11e0000-0000-4000-8000-000000000805', 'a11e0000-0000-4000-8000-000000000002', 'Ночной пик 9 — это уже к врачу, не только дневник.', 'amber', true, true),
('e11e0000-0000-4000-8000-000000000019', 'c11e0000-0000-4000-8000-000000000821', 'a11e0000-0000-4000-8000-000000000003', 'Повторила через 2 минуты — 146/90. Беру первое.', 'slate', true, true),
('e11e0000-0000-4000-8000-000000000020', 'c11e0000-0000-4000-8000-000000000828', 'a11e0000-0000-4000-8000-000000000001', 'Стресс плюс никотин — логично, что скакнуло.', 'violet', true, true)
...
('d11e0000-0000-4000-8000-000000000033', 'b11e0000-0000-4000-8000-000000000071', 'Приступы по дням', 'timeline', '{"aggregation":"count","dateFieldId":"started_at"}'::jsonb),
('d11e0000-0000-4000-8000-000000000034', 'b11e0000-0000-4000-8000-000000000071', 'Пик боли во времени', 'stem', '{"aggregation":"avg","dateFieldId":"started_at","valueFieldId":"intensity"}'::jsonb),
('d11e0000-0000-4000-8000-000000000035', 'b11e0000-0000-4000-8000-000000000071', 'Типы приступов', 'pie', '{"groupFieldId":"kind"}'::jsonb),
('d11e0000-0000-4000-8000-000000000036', 'b11e0000-0000-4000-8000-000000000071', 'Средний пик', 'kpi', '{"valueFieldId":"intensity","aggregation":"avg"}'::jsonb),
('d11e0000-0000-4000-8000-000000000037', 'b11e0000-0000-4000-8000-000000000072', 'Систолическое', 'line', '{"aggregation":"avg","dateFieldId":"measured_at","valueFieldId":"systolic"}'::jsonb),
('d11e0000-0000-4000-8000-000000000038', 'b11e0000-0000-4000-8000-000000000072', 'Пульс', 'line', '{"aggregation":"avg","dateFieldId":"measured_at","valueFieldId":"pulse"}'::jsonb),
('d11e0000-0000-4000-8000-000000000039', 'b11e0000-0000-4000-8000-000000000072', 'Оценки', 'pie', '{"groupFieldId":"category"}'::jsonb),
('d11e0000-0000-4000-8000-000000000040', 'b11e0000-0000-4000-8000-000000000072', 'Среднее давление', 'kpi', '{"valueFieldId":"systolic","aggregation":"avg"}'::jsonb)
...
('b11e0000-0000-4000-8000-000000000071', 'a11e0000-0000-4000-8000-000000000001'),
('b11e0000-0000-4000-8000-000000000072', 'a11e0000-0000-4000-8000-000000000001')
